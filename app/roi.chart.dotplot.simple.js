function generateDotPlot(dataCol, plotID, divID, reverseScale, customDomain, scaleModifier, tooltipExtra, varDesc){
	...
	//  calculate rank of project
	// var calcRank = sort(function(a,b){return b-a}); // sorts
	// console.log("Rank is "+ calcRank);
...
//          .attr("stroke", "black"); 
	...
	function updateROI(dataCol, plotID, scaleModifier, tooltipExtra, varDesc){
		var w = 320; //svg width
		var h = 40; //svg height
		var hPadding = 25;
		var vPadding = 20;
    ...
    if (key == "tnc_dollar"){
    	d3.select("span#roiType").text("Per TNC $ (M)");
			...
			updateROI("Critical Habitat (acres)","critical_habitat", "TNC Dollars at Risk (2014$ M)", "Critical Habitat Species");					
